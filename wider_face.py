...
class wider_face(imdb):
    def __init__(self, image_set, devkit_path=None):
        ...
        print 'wider_face image size = {}'.format(len(self._image_index))
    ...
    def image_path_from_index(self, index):
        ...
        """
        image_path = os.path.join(self._data_path, 'WIDER_' + 
            self._image_set, 'images', index)
    ...
    def _load_image_set_index(self):
        ...
        image_set_file = os.path.join(self._data_path, 'wider_face_' + 
            self._image_set + '.txt')
    ...
    def gt_roidb(self):
        ...
        gt_roidb = [self._load_wider_face_annotation(index)
    ...
    def _load_wider_face_annotation(self, index):
        """
